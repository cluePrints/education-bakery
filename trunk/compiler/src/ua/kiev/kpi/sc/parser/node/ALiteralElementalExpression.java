...
public final class ALiteralElementalExpression extends PElementalExpression
{
    private PLiteral _literal_;

    public ALiteralElementalExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALiteralElementalExpression(
            cloneNode(this._literal_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseALiteralElementalExpression(this);
    }

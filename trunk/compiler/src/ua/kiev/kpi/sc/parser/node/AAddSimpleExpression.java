...
public final class AAddSimpleExpression extends PSimpleExpression
{
    private PSummand _summand_;
    private TPlus _plus_;
    private PSimpleExpression _simpleExpression_;

    public AAddSimpleExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAddSimpleExpression(
    ...
    {
        ((Analysis) sw).caseAAddSimpleExpression(this);
    }

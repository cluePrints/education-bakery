...
public class Measure extends BusinessEntity {
	...
	@CouldNotBeEmpty(message="«начение измерени€ должно быть задано.")
	...
	@CouldNotBeEmpty(message="ѕараметр, который был измерен должен быть указан.")
	...
	@CouldNotBeEmpty(message="ƒата произведени€ измерени€ должна быть задана.")
	public Date getTime() {
		return time;
	}

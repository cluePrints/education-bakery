...
public final class ANormalFunctionBody extends PFunctionBody
{
    ...
    public Object clone()
    {
        return new ANormalFunctionBody(
    ...
    {
        ((Analysis) sw).caseANormalFunctionBody(this);
    }

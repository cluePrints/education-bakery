...
public final class AArrayVariableType extends PVariableType
{
    private PType _type_;
    private TLBkt _lBkt_;
    private TRBkt _rBkt_;

    public AArrayVariableType()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAArrayVariableType(this);
    }

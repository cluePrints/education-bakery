...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTDoubleQuote(@SuppressWarnings("unused") TDoubleQuote node)
    {
        this.index = 9;
    }
    ...
    @Override
    public void caseTLiteralBoolean(@SuppressWarnings("unused") TLiteralBoolean node)
    {
        this.index = 41;
    }

    @Override
    public void caseTLiteralNull(@SuppressWarnings("unused") TLiteralNull node)
    {
        this.index = 42;
    }
    ...
    @Override
    public void caseTNonNegativeInteger(@SuppressWarnings("unused") TNonNegativeInteger node)
    {
        this.index = 44;
    }
